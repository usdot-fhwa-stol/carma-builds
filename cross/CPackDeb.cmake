...
function(cpack_deb_prepare_package_vars)
  ...
  if(CPACK_DEBIAN_DEBUGINFO_PACKAGE AND CPACK_DEB_UNSTRIPPED_FILES)
    set(OBJCOPY_EXECUTABLE ${CPACK_OBJCOPY_EXECUTABLE})
  ...
  if(CPACK_DEBIAN_PACKAGE_SHLIBDEPS)
    ...
    if(SHLIBDEPS_EXECUTABLE)
      ...
      if(CONTAINS_EXECUTABLE_FILES_)
        ...
        if(CPACK_DEBIAN_PACKAGE_SHLIBDEPS_EXCLUDES)
          unset(SHLIBDEPS_EXCLUDES_OPTIONS)
          foreach(exclusion IN LISTS CPACK_DEBIAN_PACKAGE_SHLIBDEPS_EXCLUDES)
            list(APPEND SHLIBDEPS_EXCLUDES_OPTIONS "-x${exclusion}")
          endforeach()
        endif()
        ...
        # -O : print to STDOUT
        execute_process(COMMAND ${SHLIBDEPS_EXECUTABLE} ${PRIVATE_SEARCH_DIR_OPTIONS} ${SHLIBDEPS_EXCLUDES_OPTIONS} ${IGNORE_MISSING_INFO_FLAG} -O ${CPACK_DEB_BINARY_FILES}
          WORKING_DIRECTORY "${CPACK_TEMPORARY_DIRECTORY}"
          COMMAND_ECHO STDOUT
          ...
          OUTPUT_STRIP_TRAILING_WHITESPACE )
        if(CPACK_DEBIAN_PACKAGE_DEBUG)
          message("CPackDeb Debug: SHLIBDEPS_OUTPUT: ${SHLIBDEPS_OUTPUT}")
